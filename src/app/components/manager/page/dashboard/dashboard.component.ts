...
@Component({
  ...
  imports: [DashboardKpiComponent,DashboardChartBarComponent,DashboardChartDonutComponent,DashboardChartLinearComponent,DashboardChartHorizontalBarComponent],
