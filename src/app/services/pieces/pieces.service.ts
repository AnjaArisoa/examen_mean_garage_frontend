...
export class PiecesService {
    ...
    getPiecesByRdv(id: string): Observable<any> {
        return this.http.get(`${this.apiUrl}/pieces-by-rdv/${id}`);
    }

    deleteByRdv(rdvId: string): Observable<any> {
        return this.http.delete(`${this.apiUrl}/reservation-pieces/${rdvId}`);
    }
}
